...
const Appointments = () => {
  ...
  return (
    ...
    <div className="max-w-4xl mx-auto p-6 bg-teal-50 rounded-xl shadow-lg">
      <ToastContainer />
      <h1 className="text-3xl font-bold text-center text-teal-600 mb-6">Appointment Management</h1>

      {/* Patient Selection */}
      <div className="mb-6">
        <label htmlFor="patientSelect" className="block text-lg font-medium text-teal-700 mb-2">Select Patient:</label>
        <select
          id="patientSelect"
      ...
      {selectedPatient && (
        <div className="space-y-6">
          {/* Date Selection */}
          <div className="mb-4">
            <label htmlFor="dateSelect" className="block text-lg font-medium text-teal-700 mb-2">Select Date:</label>
            <input
              type="date"
              id="dateSelect"
              className="w-full p-3 border border-teal-300 rounded-lg bg-white focus:ring-2 focus:ring-teal-500"
          ...
          {selectedDate && availableTimeSlots.length > 0 && (
            <div className="mb-4">
              <label htmlFor="timeSlotSelect" className="block text-lg font-medium text-teal-700 mb-2">Select Time Slot:</label>
              <select
                id="timeSlotSelect"
                className="w-full p-3 border border-teal-300 rounded-lg bg-white focus:ring-2 focus:ring-teal-500"
                onChange={handleTimeSlotChange}
          ...
          {/* Reason for Appointment */}
          <div className="mb-4">
            <label htmlFor="reasonInput" className="block text-lg font-medium text-teal-700 mb-2">Reason for Appointment:</label>
            <textarea
              id="reasonInput"
              className="w-full p-3 border border-teal-300 rounded-lg bg-white focus:ring-2 focus:ring-teal-500"
              value={reason}
